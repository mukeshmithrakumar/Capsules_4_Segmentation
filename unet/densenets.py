...
from keras.layers import Dense, Dropout, Activation, Reshape, Conv2D, Conv2DTranspose, UpSampling2D, MaxPooling2D
from keras.layers import AveragePooling2D, GlobalMaxPooling2D, GlobalAveragePooling2D, Input, concatenate
